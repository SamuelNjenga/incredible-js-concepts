...
// JavaScript interprets (or unboxes) statements. When we use bracket notation, it sees the first opening bracket [ and keeps going until it finds the closing bracket ]. 
// Only then, it will evaluate the statement. mouse[bird.size]: 
// First it evaluates bird.size, which is "small". mouse["small"] returns true
